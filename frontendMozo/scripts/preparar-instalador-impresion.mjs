...
if (process.platform === 'win32') {
    ...
    throw new Error('Falta el instalador de impresión. Generalo con tools/qz/windows/Build-PrintingSetup.ps1 en Windows y copiá el artefacto a public/downloads antes de publicar.');
}
