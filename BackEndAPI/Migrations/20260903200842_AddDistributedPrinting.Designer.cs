...
namespace BackEndAPI.Migrations
{
    ...
    [Migration("20260903200842_AddDistributedPrinting")]
    partial class AddDistributedPrinting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEndAPI.Models.Printing.PrintJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<short>("CopiesSnapshot")
                        .HasColumnType("smallint");
                    ...
                    b.Property<string>("EncodingSnapshot")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.Property<string>("FormatSnapshot")
                        .IsRequired()
                        .HasMaxLength(16)
                    ...
                    b.Property<short>("PaperWidthMmSnapshot")
                        .HasColumnType("smallint");
                    ...
                    b.Property<Guid?>("ReprintOfJobId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("RequestId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("RequestedByPersonaId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("SpoolAcceptedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("SystemPrinterNameSnapshot")
                        .IsRequired()
                        .HasMaxLength(260)
                    ...
                    b.HasIndex("ReprintOfJobId");

                    b.HasIndex("RouteId");

                    b.HasIndex("StationId");

                    b.HasIndex("IdSucursal", "IdempotencyKey")
                        .IsUnique();

                    b.HasIndex("IdSucursal", "RequestId");

                    b.HasIndex("Status", "LeaseExpiresAt")
                        .HasFilter("\"Status\" IN ('Leased', 'Dispatching')");

                    b.HasIndex("StationId", "Status", "AvailableAt", "CreatedAt")
                        .HasFilter("\"Status\" IN ('Pending', 'RetryScheduled')");

                    b.ToTable("PrintJobs", t =>
                        {
                            t.HasCheckConstraint("CK_PrintJobs_AttemptCount", "\"AttemptCount\" >= 0");

                            t.HasCheckConstraint("CK_PrintJobs_CopiesSnapshot", "\"CopiesSnapshot\" BETWEEN 1 AND 10");

                            t.HasCheckConstraint("CK_PrintJobs_Expiry", "\"ExpiresAt\" > \"CreatedAt\"");

                            t.HasCheckConstraint("CK_PrintJobs_PaperWidthMmSnapshot", "\"PaperWidthMmSnapshot\" IN (58, 80)");

                            t.HasCheckConstraint("CK_PrintJobs_Versions", "\"SchemaVersion\" > 0 AND \"TemplateVersion\" > 0");
                        });
                });

            modelBuilder.Entity("BackEndAPI.Models.Printing.PrintJobAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PrintJobId", "LeaseId")
                        .IsUnique();

                    b.ToTable("PrintJobAttempts");
                });

            modelBuilder.Entity("BackEndAPI.Models.Printing.PrintRoute", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("MaxQueueAgeSeconds")
                        .HasColumnType("integer");

                    b.Property<string>("OfflinePolicy")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)");
                    ...
                    b.HasIndex("IdSucursal", "DocumentType")
                        .IsUnique()
                        .HasFilter("\"ProductionAreaId\" IS NULL");

                    b.HasIndex("IdSucursal", "DocumentType", "ProductionAreaId")
                        .IsUnique()
                        .HasFilter("\"ProductionAreaId\" IS NOT NULL");

                    b.ToTable("PrintRoutes", t =>
                        {
                            t.HasCheckConstraint("CK_PrintRoutes_MaxQueueAgeSeconds", "\"MaxQueueAgeSeconds\" BETWEEN 30 AND 86400");
                        });
                });

            modelBuilder.Entity("BackEndAPI.Models.Printing.PrintRouteDestination", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PrintRouteId", "PrinterDeviceId")
                        .IsUnique();

                    b.ToTable("PrintRouteDestinations", t =>
                        {
                            t.HasCheckConstraint("CK_PrintRouteDestinations_Copies", "\"Copies\" BETWEEN 1 AND 10");

                            t.HasCheckConstraint("CK_PrintRouteDestinations_Order", "\"Order\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("BackEndAPI.Models.Printing.PrinterDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SystemPrinterNameNormalized")
                        .IsRequired()
                        .HasMaxLength(260)
                        .HasColumnType("character varying(260)");
                    ...
                    b.HasIndex("StationId", "SystemPrinterNameNormalized")
                        .IsUnique();

                    b.ToTable("PrinterDevices", t =>
                        {
                            t.HasCheckConstraint("CK_PrinterDevices_PaperWidthMm", "\"PaperWidthMm\" IN (58, 80)");
                        });
                });
            ...
            modelBuilder.Entity("BackEndAPI.Models.Printing.PrintingStation", b =>
                {
                    ...
                    b.Property<string>("LastQzVersion")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
            ...
            modelBuilder.Entity("BackEndAPI.Models.Printing.ProductProductionAreaAssignment", b =>
                {
                    b.Property<Guid>("IdSucursal")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("IdSucursal", "ProductId");

                    b.HasIndex("ProductId");

                    b.HasIndex("ProductionAreaId");

                    b.ToTable("ProductProductionAreaAssignments");
                });

            modelBuilder.Entity("BackEndAPI.Models.Printing.ProductionArea", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IdSucursal", "NameNormalized")
                        .IsUnique();

                    b.ToTable("ProductionAreas");
                });

            modelBuilder.Entity("BackEndAPI.Models.Printing.VisitOrderCommand", b =>
                {
            ...
            modelBuilder.Entity("BackEndAPI.Models.ProductosPorVisita", b =>
                {
                    ...
                    b.HasIndex("IdVisita", "AddCommandId");
            ...
            modelBuilder.Entity("BackEndAPI.Models.Printing.PrintJob", b =>
                {
                    ...
                    b.HasOne("BackEndAPI.Models.Printing.PrinterDevice", "PrinterDevice")
                        .WithMany("Jobs")
                        .HasForeignKey("PrinterDeviceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BackEndAPI.Models.Printing.PrintJob", "ReprintOfJob")
                        .WithMany()
                        .HasForeignKey("ReprintOfJobId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BackEndAPI.Models.Printing.PrintRoute", "Route")
                        .WithMany("Jobs")
            ...
            modelBuilder.Entity("BackEndAPI.Models.Printing.PrintJobAttempt", b =>
                {
                    b.HasOne("BackEndAPI.Models.Printing.PrintJob", "PrintJob")
                        .WithMany("Attempts")
            ...
            modelBuilder.Entity("BackEndAPI.Models.Printing.PrintRoute", b =>
                {
                    b.HasOne("BackEndAPI.Models.Sucursal", "Sucursal")
                        .WithMany("PrintRoutes")
                        .HasForeignKey("IdSucursal")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BackEndAPI.Models.Printing.ProductionArea", "ProductionArea")
                        .WithMany("Routes")
            ...
            modelBuilder.Entity("BackEndAPI.Models.Printing.PrintRouteDestination", b =>
                {
                    b.HasOne("BackEndAPI.Models.Printing.PrintRoute", "PrintRoute")
                        .WithMany("Destinations")
                        .HasForeignKey("PrintRouteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BackEndAPI.Models.Printing.ProductProductionAreaAssignment", b =>
                {
                    b.HasOne("BackEndAPI.Models.Sucursal", "Sucursal")
                        .WithMany("ProductProductionAreaAssignments")
                        .HasForeignKey("IdSucursal")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BackEndAPI.Models.Producto", "Product")
                        .WithMany("ProductionAreaAssignments")
            ...
            modelBuilder.Entity("BackEndAPI.Models.Printing.VisitOrderCommand", b =>
                {
                    b.HasOne("BackEndAPI.Models.Visita", "Visit")
                        .WithMany()
            ...
            modelBuilder.Entity("BackEndAPI.Models.Producto", b =>
                {
                    b.Navigation("ProductionAreaAssignments");
                });
            ...
            modelBuilder.Entity("BackEndAPI.Models.Sucursal", b =>
                {
                    ...
                    b.Navigation("PrintRoutes");

                    b.Navigation("PrintingStations");

                    b.Navigation("ProductProductionAreaAssignments");
